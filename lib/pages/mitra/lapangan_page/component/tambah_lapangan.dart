...
class TambahLapanganPage extends StatefulWidget {
  ...
  @override
  State<TambahLapanganPage> createState() => _TambahLapanganPageState();
}
...
class _TambahLapanganPageState extends State<TambahLapanganPage> {
  ...
  void _uploadLapangan() async {
    ...
    var data = await ApiRepository().daftarLapangan(mytoken,
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                Text(
                  'Lapangan ${widget.myLapangan.length + 1}',
